...
class AppDetailPage extends StatefulWidget {
  final AppData ShowCard;

  const AppDetailPage({super.key, required this.ShowCard});

  @override
  State<AppDetailPage> createState() => _AppDetailPagesState();
}

class _AppDetailPagesState extends State<AppDetailPage> {
                      ...
                      children: [
                        Padding(
                          ...
                          child: GameImageGallery(
                            media: widget.ShowCard.screenshots,
                          ),
                        ),
                          ...
                          children: [
                            Expanded(
                              ...
                              child: DownloadButton(
                                installed: widget.ShowCard.isDownloaded,
                                onPressed: () async {
                                  if (widget.ShowCard.isDownloaded) {
                                    print("Launch Game");
                                  ...
                                  if (success) {
                                    setState(() {
                                      widget.ShowCard.isDownloaded = true;
                                    });
                                  }
                                },
                              ),
  ...
  Widget WhishLists() {
    return InkWell(
      ...
      onTap: () async {
        if (widget.ShowCard.whishlist) {
          await WhishlistService.removeFromWhishlist(widget.ShowCard.title);
        } else {
          await WhishlistService.addToWhishlist(widget.ShowCard.title);
        }

        setState(() {
          widget.ShowCard.whishlist = !widget.ShowCard.whishlist;
        });
      },
      child: Container(
        width: double.infinity,
        ...
        child: Row(
          ...
          children: [
            Icon(
              widget.ShowCard.whishlist ? Icons.bookmark : Icons.bookmark_border,
              color: Colors.white,
            ),
  ...
  Widget buildAboutSection() {
    return FutureBuilder<String>(
      future: GameService.loadDescription(widget.ShowCard.description),
