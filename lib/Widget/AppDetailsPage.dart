...
class _AppDetailPagesState extends State<AppDetailPage> {
                          ...
                          children: [
                            Expanded(
                              ...
                              child: DownloadButton(
                                installed: widget.app.isDownloaded,
                                onPressed: () async {
                                  if (widget.app.isDownloaded) {
                                    print("Launch Game");
  ...
  Widget WhishLists() {
    return InkWell(
      ...
      onTap: () async {
        if (widget.app.whishlist) {
          await WhishlistService.removeFromWhishlist(widget.app.title);
        } else {
          await WhishlistService.addToWhishlist(widget.app.title);
        }

        setState(() {
          widget.app.whishlist = !widget.app.whishlist;
        });
      },
      child: Container(
        width: double.infinity,
        ...
        child: Row(
          ...
          children: [
            Icon(
              widget.app.whishlist ? Icons.bookmark : Icons.bookmark_border,
              color: Colors.white,
            ),
  ...
  Widget buildAboutSection() {
    return FutureBuilder<String>(
      future: GameService.loadDescription(widget.app.description),
